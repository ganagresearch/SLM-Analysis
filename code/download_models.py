...
# Use /workspace/models as the download and cache location
cache_dir = "/workspace/models" 

os.makedirs(cache_dir, exist_ok=True)
print(f"Using model download/cache directory: {cache_dir}")
...
for model_id in model_ids:
    ...
    try:
        ...
        print(f"Successfully downloaded model and tokenizer for {model_id} to {cache_dir}")
